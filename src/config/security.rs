// ── Autonomy / Security config types ──────────────────────────────
//
// Mechanical extraction from config/schema.rs.  Re-exported via
// `pub use crate::config::security::*;` so downstream imports are unchanged.

pub use crate::security::AutonomyLevel;
use schemars::JsonSchema;
use serde::{Deserialize, Serialize};

use super::schema::default_true;
